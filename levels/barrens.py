            ...
            if args[0] == 'pick_up':
                if pygame.sprite.collide_rect(self, gb.player.pick_up_collision) and self.goto:
                    if gb.player.bulb == 'with_bulb':
                        gb.msg_query.append((obj.MSG('Never saw portals. I hope it doesn\'t hurts.'), uf.face('niko', 'what')))
                        self.called = 1
                        gb.mode = 1
...
tile_map = [
    ...
    ['  ', '  ', 'fl', 'fl', 'fl', 'fl', 'fl', 'fl', 'fl', '  ', '  ', '  ', 'fl', 'fl', 'fl', 'fl', 'fl', 'fl', 'fl',
     ...
     '  ', '  ', '  ', 'fl', 'fl', '  ', '  ', ],
    ['  ', '  ', 'fl', '  ', '  ', '  ', '  ', '  ', 'fl', '  ', '  ', '  ', '  ', '  ', 'fl', '  ', '  ', '  ', '  ',
     '  ', 'fl', '  ', '  ', 'w2', 'w2', 'fl', 'w2', 'w2', '  ', '  ', '  ', 'w2', 'w2', 'w2', 'w1', 'fl', '  ', '  ',
     '  ', '  ', '  ', 'fl', '  ', '  ', '  ', ],
    ['  ', '  ', 'fl', '  ', 'w2', 'w2', 'w2', 'w2', 'fl', '  ', '  ', '  ', '  ', '  ', 'fl', '  ', '  ', '  ', '  ',
     '  ', 'fl', '  ', '  ', 'w1', 'w1', 'fl', 'w1', 'w1', '  ', '  ', '  ', 'w1', 'w1', 'w1', 'fl', 'fl', '  ', '  ',
     '  ', '  ', '  ', 'fl', '  ', '  ', '  ', ],
    ['  ', '  ', 'fl', '  ', 'w1', 'w1', 'w1', 'w1', 'fl', '  ', '  ', '  ', 'w2', 'w2', 'fl', 'w2', 'w2', '  ', '  ',
     '  ', 'fl', 'w2', 'w2', 'fl', 'fl', 'fl', 'fl', 'fl', 'w2', 'w2', 'w2', 'fl', 'fl', 'fl', 'fl', '  ', '  ', '  ',
     '  ', '  ', '  ', 'fl', '  ', '  ', '  ', ],
    ['  ', '  ', 'fl', '  ', 'fl', 'fl', 'fl', 'fl', 'fl', '  ', '  ', '  ', 'w1', 'w1', 'fl', 'w1', 'w1', '  ', '  ',
     '  ', 'fl', 'w1', 'w1', 'fl', 'fl', 'fl', 'fl', 'fl', 'w1', 'w1', 'w1', 'fl', 'fl', 'fl', 'fl', 'w2', 'w2', 'w2',
     'w2', 'w2', 'w2', 'fl', '  ', '  ', '  ', ],
    ['  ', '  ', 'fl', '  ', 'fl', '  ', '  ', '  ', 'fl', 'w2', 'w2', 'w2', 'fl', 'fl', 'fl', 'fl', 'fl', '  ', '  ',
     '  ', 'fl', 'fl', 'fl', 'fl', 'fl', 'fl', 'fl', 'fl', 'fl', 'fl', 'fl', 'fl', 'fl', 'fl', 'fl', 'w1', 'w1', 'w1',
     'w1', 'w1', 'w1', 'fl', '  ', '  ', '  ', ],
...
items_on_ground_links = {
    ...
    'gt': [obj.DynamicClickableDoor, [(r'tiles/barrens/ddoor1.png', (255, 0, 0))]],
    'p1': [Portal, [(portals, (255, 0, 0)), 'hub']],
    '  ': None
}
items_map = [
    ['  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', '  ', ],
